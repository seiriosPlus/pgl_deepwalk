...
time python -u single_train.py --num_sample_workers 4 --num_nodes $num_nodes --optimizer $optimizer --walkpath_files $walkpath_files --epoch $epoch \
            ...
            --batch_size $batch_size --steps_per_save $steps_per_save --train_files $train_files --edge_path=./graph_data.bak --save_path=./train_modle --worker_num=8 --cpu_num=8   >local_dir/single.log 2>&1 &
